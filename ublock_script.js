                ...
                if (b.includes("__reactProps")) {
                    ...
                    try {
                        if (b.children.props.children.props.edge.category.includes("SPONSORED")) {
                            ...
                            var d = a.querySelector("a[href][role='link']:not([aria-hidden]):not([aria-label])");
                            d && console.log("Ad blocked based on property [" + c + "] -> " + d.textContent)
                        }
                    } catch (e) {}
                }
            })
...
/// fb_sponsor_3.js
(function() {
    1 == window.location.href.includes("/watch") && (new MutationObserver(function() {
        document.querySelectorAll('div[data-pagelet="MainFeed"] div:not([class]):not([id]) > div[class]:not([style*="display: none"])').forEach(function(a) {
            Object.keys(a).forEach(function(b) {
                if (b.includes("__reactFiber")) {
                    b = a[b];
                    try {
                        b.alternate.memoizedProps.children.props.video.props.children.props.story.sponsored_data.__typename.includes("SponsoredData") && (a.style = "display: none !important;")
                    } catch (c) {}
                }
            })
        })
